...
async function main () {
  ...
  const wallet = Address.parse('0QBQBwSJrdPLEwKammiSQK4TK0ZmGPV4ycey-ErUPrwmYSAM');
  ...
  console.log('values', complexity, last_success.toString(), seed, target_delta.toString(), min_cpl.toString(), max_cpl.toString());
